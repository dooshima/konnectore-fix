...
const styles = StyleSheet.create({
  ...
  text: {
    color: 'black',
    fontSize: 15,
    fontFamily: 'Acumin Pro,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"',
  },
